...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: '/project-spaceshooter.png',
  ...
  const categories = ['All', 'Full Stack', '3D Graphics', 'AI/ML', 'JDBC', 'Networking'];
